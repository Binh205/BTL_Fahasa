...
<style>
    .hero-section {
        background: linear-gradient(rgba(201, 33, 39, 0.7), rgba(247, 148, 30, 0.7)), url('https://images.unsplash.com/photo-1495741545814-2d7f4d75ea09?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80') no-repeat center center;
    ...
    .section-title::after {
        ...
        width: 100px;
        height: 4px;
        background: linear-gradient(to right, var(--fahasa-red), var(--fahasa-orange));
        border-radius: 2px;
    }
...
<div class="container">
    ...
    <div class="row banner-section">
        <div class="col-lg-8 mb-4">
            <a href="#" class="banner-item" style="background: linear-gradient(135deg, var(--fahasa-red) 0%, var(--fahasa-orange) 100%);">
