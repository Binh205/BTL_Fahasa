...
(11) NOT NULL,
  ...
  `parent_id` int
(11) DEFAULT NULL COMMENT 'Để trả lời bình luận khác',
...
id`,
`name
`, `email`, `subject`, `message`, `status`, `created_at`) VALUES
...
INSERT INTO `flashsale_product` (`
sale_id`,
`product_id
`, `discount_value`, `quantity`) VALUES
(1, 1, 10000.00, 50),
(1, 2, 8500.00, 30),
(2, 3, 25000.00, 5),
(2, 4, 12000.00, 10),
...
(255) DEFAULT NULL,
  `author_id` int
(11) NOT NULL COMMENT 'ID của admin viết bài',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
(),
...
order_id`,
`payment_id
`, `shipping_fee`, `note`, `created_date`, `status`, `point_earned`, `point_used`, `total`) VALUES
...
payment_id`,
`customer_id
`, `payment_method`, `created_date`) VALUES
...
(50) DEFAULT NULL,
  `pages` int
(11) DEFAULT NULL COMMENT 'Number of pages in the product.',
...
(12,2) NOT NULL,
  `old_price` decimal
(12,2) DEFAULT NULL COMMENT 'The original price before discount. NULL if not on sale.',
  `weight` decimal
(10,2) DEFAULT NULL,
  `dimensions` varchar
(50) DEFAULT NULL COMMENT 'Physical dimensions of the product (e.g., 13 x 20.5 cm).',
  `size` varchar
(255) DEFAULT NULL
) ;
...
`year`,
`language
`, `pages`, `product_type`, `stock_quantity`, `price`, `old_price`, `weight`, `dimensions`, `size`) VALUES
...
review_id`,
`product_id
`, `customer_id`, `rating`, `review_text`, `review_date`, `image_url`) VALUES
...
product_id`,
`image_url
`, `ordinal_number`, `upload_date`) VALUES
...
(100) DEFAULT NULL,
  `user_id` int
(11) DEFAULT NULL COMMENT 'ID của người dùng đặt câu hỏi',
  `status` varchar
(50) NOT NULL DEFAULT 'pending' COMMENT 'Trạng thái: pending, answered',
  `created_at` datetime DEFAULT current_timestamp
()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
id`,
`question
`, `answer`, `category`, `user_id`, `status`, `created_at`) VALUES
...
ship_code`,
`shipping_unit
`, `tracking_num`, `weight`, `status`, `last_update`, `shipping_address`, `note`) VALUES
...
user_id`,
`branch
`, `hired_date`, `salary`, `is_admin`) VALUES
...
user_id`,
`password
`, `fullname`, `email`, `phone`, `role`, `note`, `created_date`) VALUES
...
voucher_code`,
`usage_limit
`, `used_count`, `start_time`, `end_time`, `min_order_value`, `max_sale_value`, `discount`) VALUES
...
ADD PRIMARY KEY
(`id`),
ADD KEY `FK_Comment_News`
(`news_id`),
ADD KEY `FK_Comment_User`
(`user_id`),
ADD KEY `FK_Comment_Parent`
(`parent_id`);
...
ADD PRIMARY KEY
(`wishlist_id`),
ADD UNIQUE KEY `unique_user_product`
(`user_id`,`product_id`),
ADD KEY `product_id`
(`product_id`),
ADD KEY `idx_wishlist_user`
(`user_id`);
...
ALTER TABLE `users`
  MODIFY `user_id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `author_of_product`
ADD CONSTRAINT `FK_Au_Product` FOREIGN KEY
...
--
ALTER TABLE `cart_items`
ADD CONSTRAINT `cart_items_ibfk_1` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`) ON
DELETE CASCADE,
ADD CONSTRAINT `cart_items_ibfk_2` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`) ON
DELETE CASCADE;
...
--
ALTER TABLE `categorizes`
ADD CONSTRAINT `FK_Cg_CategoryA` FOREIGN KEY
(`categoryA_id`) REFERENCES `category`
(`category_id`),
ADD CONSTRAINT `FK_Cg_CategoryB` FOREIGN KEY
(`categoryB_id`) REFERENCES `category`
(`category_id`);
...
--
ALTER TABLE `category_product`
ADD CONSTRAINT `FK_CtP_Category` FOREIGN KEY
(`category_id`) REFERENCES `category`
(`category_id`),
ADD CONSTRAINT `FK_CtP_Product` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`);
...
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `FK_Comment_Parent` FOREIGN KEY
...
--
ALTER TABLE `customer`
ADD CONSTRAINT `FK_Customer_User` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `flashsale_product`
ADD CONSTRAINT `FK_FSP_Flashsale` FOREIGN KEY
(`sale_id`) REFERENCES `flashsale`
(`sale_id`),
ADD CONSTRAINT `FK_FSP_Product` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`);
...
--
ALTER TABLE `news`
ADD CONSTRAINT `FK_News_Author` FOREIGN KEY
...
--
ALTER TABLE `order_product`
ADD CONSTRAINT `FK_OP_Order` FOREIGN KEY
(`order_id`) REFERENCES `orders`
(`order_id`),
ADD CONSTRAINT `FK_OP_Product` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`);
...
--
ALTER TABLE `order_voucher`
ADD CONSTRAINT `FK_OV_Order` FOREIGN KEY
(`order_id`) REFERENCES `orders`
(`order_id`),
ADD CONSTRAINT `FK_OV_Voucher` FOREIGN KEY
(`voucher_code`) REFERENCES `voucher`
(`voucher_code`);
...
--
ALTER TABLE `productreview`
ADD CONSTRAINT `FK_PR_Customer` FOREIGN KEY
(`customer_id`) REFERENCES `customer`
(`user_id`),
ADD CONSTRAINT `FK_PR_Product` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`);
...
--
ALTER TABLE `product_image`
ADD CONSTRAINT `FK_PI_Product` FOREIGN KEY
(`product_id`) REFERENCES `product`
(`product_id`);
...
--
ALTER TABLE `qa`
ADD CONSTRAINT `FK_QA_User` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `shipment_order`
ADD CONSTRAINT `FK_SO_Order` FOREIGN KEY
(`order_id`) REFERENCES `orders`
(`order_id`),
ADD CONSTRAINT `FK_SO_Shipment` FOREIGN KEY
(`ship_code`) REFERENCES `shipment`
(`ship_code`);
...
--
ALTER TABLE `staff`
ADD CONSTRAINT `FK_Staff_User` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `user_address`
ADD CONSTRAINT `FK_UserAddress_User` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `user_phone`
ADD CONSTRAINT `FK_UserPhone_User` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`user_id`);
