...
const PROVINCES_DATA_URL = "/BTL_Fahasa/public/vietnam_provinces-2025.10.1/vietnam_provinces/data/nested-divisions.json";
  ...
  checkoutProducts.forEach((product) => {
    ...
    const productHTML = `
      <div class="checkout-product-item">
        ...
        <div style="font-weight: 700; color: var(--fahasa-red);">
